public class TestReq1 {
    public static void main(String[] args) {
        ...
        IDCard id2 = new IDCard(100013, "John", "male", "22/07/2000", "New Zealand", 2111235);
        IDCard id3 = new IDCard(100012, "Alex", "male", "22/07/2011", "Boston", 8112345);
        try {
        ...
        try {
            ConvenientCard cc = new ConvenientCard(id3);
            System.out.println("Type of the card: " + cc.getType());
        } catch (CannotCreateCard e) {
            System.out.println(e);
        }
